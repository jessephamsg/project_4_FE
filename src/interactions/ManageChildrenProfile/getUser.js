...
export default {
    ...
    async getAllChildStats (parentID, kidName) {
        ...
        return {numberOfGamesPlayed, statsData, statsObjects}
    },
    ...
    async getAnalysedChildStats (parentID, kidName) {
        const {numberOfGamesPlayed, statsData, statsObjects} = await this.getAllChildStats(parentID, kidName);
        ...
        return {numberOfGamesPlayed, totalScore, avgAttemptsBeforeSuccess, completionRate, trialAndErrFreq, recentGameObjects, gamesMostPlayed, allGamesAttempted}
    }
